						...
						$.getJSON(url, function(data){
							...
							$.each(data.data, function(i,shot){
								  ...
								  if (instagram_username == o.user){
									  //var first_name = shot.first_name;
									  //var last_name = shot.last_name;
									  var user_id = shot.id;
									  //var profile_picture = shot.profile_picture;
									  //var $img = $("<img\>", {"src": profile_picture});
									  //var $url = $("<a\>", {"href": img_url}).append($img);
									  //$(obj).append($img).append(instagram_username + " " + user_id + " " + first_name + " " + last_name);
									if (user_id != ""){	
										...
										$.getJSON(url, function(data){
											$.each(data.data, function(i,shot){
											  ...
											  //var $url = $("<a\>", {"href": img_url}).append($img);
											  var img_title = shot.caption.text;
